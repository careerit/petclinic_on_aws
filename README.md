...
## Build and Deploy with  AWS Code Pipeline

# CodeBuild

## Overview

Codebuild is part of AWS DevOps tooling. Codebuild is used to build applications. 

### Project Source 

A Git repository where the source code is located.



### Buildspec
A yaml file describing the steps inside the build job.
